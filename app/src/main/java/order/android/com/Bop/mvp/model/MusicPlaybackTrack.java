...
public class MusicPlaybackTrack implements Parcelable{
    ...
    public BopUtil.IdType mSourceType;
    ...
    public MusicPlaybackTrack(Parcel in) {
        ...
        mSourceType = BopUtil.IdType.getTypeById(in.readInt());
        mSourcePosition = in.readInt();
    }

    public MusicPlaybackTrack(long id, long sourceId, BopUtil.IdType type, int sourcePosition) {
        mId = id;
        mSourceId = sourceId;
        mSourceType = type;
