...
public class MusicPlayer {
    ...
    public static void playAll(final Context context, final long[] list, int position,
                               final long sourceId, final BopUtil.IdType sourceType,
     ...
     */
    public static void playNext(Context context, final long[] list, final long sourceId, final BopUtil.IdType sourceType) {
        if (mService == null) {
            return;
        }
        try {
